            ...
            <Container>
                <div className="flex flex-col gap-8 lg:gap-12">
                    ...
                    <div className="flex flex-col gap-6 lg:gap-8">
                        ...
                        {/* Row 2: Text (35%) | Image (65%) */}
                        {/* DOM Order: Image, Text (to ensure Image first on mobile) */}
                        {/* Desktop Visual: Text Left (col 1), Image Right (col 2) */}
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[35fr_65fr] lg:gap-8">
                            ...
                            />
                            <TextCard
                                content={rows[1].textCard}
                            />
                        </div>

                        {/* Row 3: Image (65%) | Text (35%) */}
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[65fr_35fr] lg:gap-8">
...
function ImageCard({
    ...
    return (
        <div className={cn("relative w-full overflow-hidden rounded-[20px]", className)}>
            ...
            />
            {/* Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent transition-colors" />
