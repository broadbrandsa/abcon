...
const variantStyles: Record<DifferenceCardVariant, string> = {
    ...
    "light-blue": "bg-blue-50 border-blue-100 text-blue-900", // Fallback colors, assuming system tokens might not cover specific "light-blue"
    ...
    return (
        <section className={cn("py-16 md:py-24 overflow-hidden", className)}>
            ...
            <div className="w-full overflow-x-auto pb-8 -mb-8 px-4 md:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <Container className="px-0 md:px-8"> {/* Reset padding for scroll container to align with screen edge if needed, but keeping container alignment usually better */}
                            ...
                            >
                                <div className="space-y-6">
                                    ...
                                    <Text className={cn(
                                        ...
                                        // Adjust text color if needed for dark variants
